...
admin.initializeApp({
  credential: admin.credential.cert(require('../agrispot-cd94f-firebase-adminsdk-oqhvo-b17daec49e.json')), // Add path to Firebase service account key
});
...
exports.login = async (req, res) => {
  ...
  try {
    ...
    res.json({ token, role: user.role, email: user.email });  // Include email in the response
  } catch (error) {
